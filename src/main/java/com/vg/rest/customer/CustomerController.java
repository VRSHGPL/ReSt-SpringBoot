...
/**
 * /** TODO validate incoming fields - 400 - BAD REQUEST / 405 handle duplicates - 409 CONFLICT based Authorization - 401 - UNAUTHORIZED Add HATEOAS
 * links for Customers and Addresses
 */
@RestController
